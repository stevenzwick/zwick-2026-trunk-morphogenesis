#!/usr/bin/env python3
"""Build the raw-input manifest for the LPM transplant workspace."""
...
try:
    from .transplant_quantification_helpers import build_raw_input_manifest
except ImportError:
    from transplant_quantification_helpers import build_raw_input_manifest
...
def run_manifest_pipeline(
    ...
    return {
        ...
        "summary_text": f"{len(manifest_df)} manifest rows",
    }
